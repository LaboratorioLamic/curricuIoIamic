...
const ICONS = {
    ...
    // Chave (Pix) — palhetão em diagonal com o anel embaixo à esquerda
    key: '<path d="M21 2l-9.6 9.6"/><path d="M15.5 7.5l3 3"/><circle cx="7.5" cy="15.5" r="5.5"/>',
    // Visualizador de imagens — zoom e rotação
